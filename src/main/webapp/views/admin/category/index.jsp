			...
			<div class="page-breadcrumb">
				<div class="row align-items-center">
					<div class="col-md-6 col-8 align-self-center">
						<h3 class="page-title mb-0 p-0">Thể loại</h3>
					...
					<div class="col-md-6 col-4 align-self-center">
						<div class="text-end">
							<a href="<%=request.getContextPath()%>/admin/category/create"
							...
							<div class="card-body">
								<div class="table-responsive">
									<table class="table stylish-table no-wrap">
										<thead>
											<tr>
												<th class="border-top-0" colspan="1">#</th>
											...
											<c:forEach var="item" items="${list}">
												<tr>
													...
													<td><a class="text-white"
														href="<%=request.getContextPath()%>/admin/category/edit/${item.id}">
															<button class="btn-info px-3 py-1 mt-3">Sửa</button>
													</a> <a class="text-white"
														href="<%=request.getContextPath()%>/admin/category/delete/${item.id}">
