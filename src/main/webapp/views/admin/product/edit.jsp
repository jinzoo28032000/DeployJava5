	...
	<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6"
		...
		<div class="page-wrapper">
			<div class="page-breadcrumb">
				<div class="row align-items-center">
					<div class="col-md-6 col-8 align-self-center">
						<h3 class="page-title mb-0 p-0">Sửa sản phẩm</h3>
			...
			<div class="container-fluid mb-5">
				<form:form action="update/${product.id}" method="post"
						...
						<div class="col-sm-4 mb-5">
							<div class="avatar-upload-product">
								...
								<div class="avatar-preview-product">
									<div id="imagePreview"
										style="background-image: url(<%=request.getContextPath()%>/images/product/${product.image});">
									</div>
								</div>
							</div>
						</div>
